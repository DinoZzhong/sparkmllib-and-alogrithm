...
public class MultiSortTest {
    ...
    public static int BUFFER_SIZE = 1024 * 4 * 10;// 一次缓冲读取

    public static int FILE_COUNT = 1024 * 1000 * 1 * 4;// 每个文件的记录数1

    public static File MAIN_FILE = new File("data/memberid.txt");//要排序的文件
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream fw = new FileOutputStream(MAIN_FILE+".random");
        OutputStreamWriter op = new OutputStreamWriter(fw,"utf-8");
/*
   ...
   /*     dout.close();
        ...
        /*MultiSortTest sort = new MultiSortTest();
